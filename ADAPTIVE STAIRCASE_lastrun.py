...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\SHRUTI\\Desktop\\psychopy\\ADAPTIVE STAIRCASE_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='WELCOME TO THE EXPERIMENT\nYour task is to decide if the pattern of lines is tilted to the LEFT or RIGHT.\nPress the LEFT ARROW (←) key if the pattern is tilted left.\nPress the RIGHT ARROW (→) key if the pattern is tilted right.\nPlease make your best guess on every trial, even if you are unsure.',
        font='Arial',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='THANK YOU SO MUCH FOR PARTICIPATING IN THE EXPERIMENT',
        font='Arial',
        pos=(0, 0), draggable=False, height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        # Run 'Begin Routine' code from fiftififty
        if random()>0.5: 
            direction = -level
            corr_resp = 'left'
        else:
        ...
        # Run 'End Routine' code from fiftififty
